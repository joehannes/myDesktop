...
var i_12509 = (0);
while(true){
if((i_12509 < arr.length)){
(arr[i_12509] = null);

var G__12512 = (i_12509 + (1));
i_12509 = G__12512;
continue;
} else {
}
...
var i_12550 = (self__.level + (1));
while(true){
if((i_12550 <= (new_level + (1)))){
(update[i_12550] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_12553 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_12553[i]));
} else {
x__$2.forward.push((((i < links_12553.length))?(links_12553[i]):null));
}

if((i < links_12553.length)){
(links_12553[i] = x__$2);
} else {
links_12553.push(x__$2);
}
...
var i_12563 = (0);
while(true){
if((i_12563 <= self__.level)){
var links_12566 = (update[i_12563]).forward;
if((x__$1 === (((i_12563 < links_12566.length))?(links_12566[i_12563]):null))){
(links_12566[i_12563] = (x__$1.forward[i_12563]));

var G__12567 = (i_12563 + (1));
i_12563 = G__12567;
continue;
} else {
var G__12568 = (i_12563 + (1));
i_12563 = G__12568;
continue;
}
} else {
...
var G__12577 = nx;
var G__12578 = (level__$1 - (1));
x = G__12577;
level__$1 = G__12578;
continue;
} else {
var G__12579 = x;
var G__12580 = (level__$1 - (1));
x = G__12579;
level__$1 = G__12580;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__12586 = nx;
var G__12587 = (level__$1 - (1));
x = G__12586;
level__$1 = G__12587;
continue;
} else {
var G__12588 = x;
var G__12589 = (level__$1 - (1));
x = G__12588;
level__$1 = G__12589;
continue;
}
