...
var G__21780 = o;
reagent.impl.template.goog$module$goog$object.set(G__21780,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__21798__delegate = function (args){
...
while (G__21799__i < G__21799__a.length) {G__21799__a[G__21799__i] = arguments[G__21799__i + 0]; ++G__21799__i;}
  args = new cljs.core.IndexedSeq(G__21799__a,0,null);
} 
...
var args = cljs.core.seq(arglist__21800);
...
var G__21781 = o;
reagent.impl.template.goog$module$goog$object.set(G__21781,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__21802__i < G__21802__a.length) {G__21802__a[G__21802__i] = arguments[G__21802__i + 0]; ++G__21802__i;}
  args = new cljs.core.IndexedSeq(G__21802__a,0,null);
} 
...
var args = cljs.core.seq(arglist__21803);
...
var G__21782 = props;
var G__21782__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21782,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21782);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21782__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21783 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21783,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21783;
}
})(),id_class);
...
var G__21784 = (cljs.core.count(argv) - first_child);
switch (G__21784) {
case (0):
...
var vec__21785 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21785,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21785,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21785,(2),null);
...
var temp__5808__auto___21805 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21805 == null)){
} else {
var key_21806 = temp__5808__auto___21805;
(jsprops.key = key_21806);
}
...
var temp__5808__auto___21807 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21807 == null)){
} else {
var key_21808 = temp__5808__auto___21807;
(jsprops.key = key_21808);
}
...
var temp__5808__auto___21809 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___21809 == null)){
} else {
var key_21810 = temp__5808__auto___21809;
(jsprops.key = key_21810);
}
...
var temp__5808__auto___21811 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21811 == null)){
} else {
var key_21812 = temp__5808__auto___21811;
(jsprops.key = key_21812);
}
...
var temp__5808__auto___21813 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21813 == null)){
} else {
var key_21814 = temp__5808__auto___21813;
(jsprops.key = key_21814);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21788_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21788_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21789 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21789,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21789,(1),null);
...
break;
default:
var G__21816 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__21817 = compiler;
v = G__21816;
compiler = G__21817;
continue;
...
var G__21793 = tag;
var G__21793__$1 = (((G__21793 instanceof cljs.core.Keyword))?G__21793.fqn:null);
switch (G__21793__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template21795 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template21795 = (function (opts,id,fn_to_element,parse_fn,meta21796){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21795.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21797,meta21796__$1){
var self__ = this;
var _21797__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21795(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21796__$1));
}));

(reagent.impl.template.t_reagent$impl$template21795.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21797){
var self__ = this;
var _21797__$1 = this;
return self__.meta21796;
}));

(reagent.impl.template.t_reagent$impl$template21795.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21795.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21795.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template21795.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21795.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21795.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21796","meta21796",1454875980,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21795.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21795.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21795");

(reagent.impl.template.t_reagent$impl$template21795.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template21795");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21795.
 */
reagent.impl.template.__GT_t_reagent$impl$template21795 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template21795(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta21796){
return (new reagent.impl.template.t_reagent$impl$template21795(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta21796));
});

}

return (new reagent.impl.template.t_reagent$impl$template21795(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
